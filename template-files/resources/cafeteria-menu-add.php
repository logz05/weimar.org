...
<div id="sb_sdw"></div>
	...
	<div id="page-data">
		...
		<textarea name="breakfast" cols="40" rows="3" id="breakfast" dir="ltr"></textarea>
		
		<label for="title">Lunch</label><br />
		<textarea name="lunch" cols="40" rows="3" id="lunch" dir="ltr"></textarea>
		
		<label for="title">Supper</label><br />
		<textarea name="supper" cols="40" rows="3" id="supper" dir="ltr"></textarea>
