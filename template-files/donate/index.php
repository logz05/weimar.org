...
{if segment_2=="confirm"}
  ...
  {exp:cartthrob:cart_items_info}
    ...
    <p>Title: {title} <br />
      ...
      <a href="{path=donate/remove-donation/{row_id}}">Delete</a><br />
      </p>
...
{exp:cartthrob:cart_empty_redirect  return="donate/donation-empty"  }

  {!-- CHECKOUT --}
  <h2>Checkout</h2>
  {!-- the checkout_form  outputs a checkout form--}
  {!-- overriding the chosen gateway with the the dev_template gateway here --}
  {exp:cartthrob:checkout_form gateway="dev_template" return="donate/order_complete"}
